            ...
            <aside class="w-64 bg-navy-900 text-white flex flex-col fixed h-full">
                ...
                <nav class="flex-1 py-6 overflow-y-auto">
                    <div class="px-4 space-y-1">
                        ...
                        <a href="{{ route('supervisor.index') }}" class="{{ request()->routeIs('supervisor*') ? 'bg-navy-800 text-white' : 'text-gray-300 hover:bg-navy-800 hover:text-white' }} flex items-center px-4 py-3 rounded-lg text-sm font-medium transition-colors">
                            <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        @can('access-qa')
                        <a href="{{ route('agents.index') }}" class="{{ request()->routeIs('agents*') ? 'bg-navy-800 text-white' : 'text-gray-300 hover:bg-navy-800 hover:text-white' }} flex items-center px-4 py-3 rounded-lg text-sm font-medium transition-colors">
                            <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">

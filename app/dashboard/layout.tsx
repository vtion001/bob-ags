...
export default function DashboardLayout({
    ...
    return (
      <div className="min-h-screen bg-navy-950 flex items-center justify-center">
        <div className="flex flex-col items-center gap-4">
          <div className="w-12 h-12 border-4 border-navy-700 border-t-cyan-500 rounded-full animate-spin"></div>
  ...
  return (
    <div className="min-h-screen bg-navy-950">
      ...
      <div className="flex">
        {/* Sidebar */}
        <aside className="hidden md:flex flex-col w-64 bg-navy-900/50 border-r border-navy-700 backdrop-blur-sm">
